...
output = function(mutation_data, mutationType){
  
  # get patient ID
  rows = which(mutation_data$Variant_Classification == mutationType)
  patientIDs = substr(mutation_data$Tumor_Sample_Barcode[rows], 1, 12)
